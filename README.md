...
<li>Agora é so utilizar o <u color="red">mesa1.php</u> e <ins>mesa2.php</ins> para controlar a aba do cliente e <u>dono.php</u> para controlar a aba do controle de pedidos

...
<li>Agora é so{c:#B81365} utilizar{/c} o <ins>mesa1.php</ins> e <ins>mesa2.php</ins> para controlar a aba do cliente e <ins>dono.php</ins> para controlar a aba do controle de pedidos

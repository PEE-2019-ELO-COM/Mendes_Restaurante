...
<li>Agora é so utilizar o <ins style="color:red;">mesa1.php</ins> e <ins>mesa2.php</ins> para controlar a aba do cliente e <ins>dono.php</ins> para controlar a aba do controle de pedidos
